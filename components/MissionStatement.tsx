...
const MissionStatement: React.FC = () => {
  return (
    <section id="whoweare-gap" className="py-32 bg-white">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-3 gap-10">
          {/* US/CA Fail - Slides in from left */}
          <div className="scroll-reveal reveal-left bg-slate-50 p-12 rounded-[4rem] border border-slate-100 relative group overflow-hidden transition-all duration-500 hover:bg-red-50/20 hover:border-red-100 hover:shadow-[0_40px_80px_rgba(239,68,68,0.08)]">
             ...
             <p className="text-slate-600 font-medium leading-relaxed">
               High payroll costs and benefit obligations make domestic staffing inefficient, and local setters often lack the specialization needed for consistent, high volume follow up.
             </p>
             <div className="mt-8 text-[10px] font-black uppercase tracking-widest text-slate-400">Inefficient Spend Ratio</div>
          </div>

          {/* PH/INDIA Fail - Scales up */}
          <div className="scroll-reveal reveal-scale bg-slate-50 p-12 rounded-[4rem] border border-slate-100 relative group overflow-hidden transition-all duration-500 hover:bg-red-50/20 hover:border-red-100 hover:shadow-[0_40px_80px_rgba(239,68,68,0.08)]">
             <div className="absolute top-0 right-0 p-8 opacity-[0.05] group-hover:opacity-10 group-hover:-rotate-12 transition-all duration-700">
             ...
             <h4 className="text-xl font-black text-slate-900 mb-6 leading-tight group-hover:text-red-600 transition-colors">
               Saturated Talent Markets (PH/India)
             </h4>
             <p className="text-slate-600 font-medium leading-relaxed">
          ...
          {/* QA Fail - Slides in from right */}
          <div className="scroll-reveal reveal-right bg-slate-50 p-12 rounded-[4rem] border border-slate-100 relative group overflow-hidden transition-all duration-500 hover:bg-red-50/20 hover:border-red-100 hover:shadow-[0_40px_80px_rgba(239,68,68,0.08)]">
